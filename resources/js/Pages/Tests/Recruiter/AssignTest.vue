    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                ...
                <div v-if="!props.users.length" class="w-full text-center text-lg font-medium">
                    Sorry, there are no available candidates for the assignment on this task.<br/>
                    Add candidates or try another test.
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
